...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            Welcome to our liquor shop — your one-stop destination for quality beer, wine,
                                            whisky, and more. We offer top brands at great prices. Whether you're
                                            celebrating or relaxing, we’ve got the perfect drink for every moment.
                                        </p>
                                        <div class="btn-box">
                                            <a href="{{ route('softDrink.show') }}" class="btn1">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="{{ route('cigratte.show') }}" class="btn1">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="{{ route('vodka.show') }}" class="btn1">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
    ...
    <section class="product_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Our <span>Best Selling Beer</span>
                </h2>
            </div>
            <div class="row">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('beer.show') }}" class="btn btn-primary">
                    View More
                </a>
            </div>
        </div>
            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col-md-6 ml-auto">
                        ...
                        <div class="btn-box">
                            <a href="{{ route('rum.show') }}" class="btn1">
                                Shop Now
                            </a>
                        </div>
                    </div>
    ...
    <section class="product_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Our <span>Best Selling Rum</span>
                </h2>
            </div>
            <div class="row">
                @foreach ($rums as $rum)
                ...
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                We deliver your favorite drinks quickly and safely—right to your doorstep.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Enjoy free shipping on all orders over a certain amount—no extra costs, just great value.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                We offer only top-quality, genuine liquor from trusted brands you know and love.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="product_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Our <span>Best Selling Vodka</span>
                </h2>
            </div>
            <div class="row">
