<x-app-layout>
    ...
    <div>
        <form action="{{ route('role.update',$role->id) }}" method="POST" enctype="multipart/form-data" class="mb-[80px]">
            @csrf
                ...
                <div class="h-auto w-full flex justify-evenly">
                    ...
                    <div class="w-3/5 h-auto shadow-md p-[20px] flex flex-col items-center gap-y-[20px]">
                        <div class="w-full flex flex-col gap-y-3">
                            ...
                            <input type="text" name="name" id="" class="w-full rounded-md" value="{{ $role->name }}">
                            @error('title')
